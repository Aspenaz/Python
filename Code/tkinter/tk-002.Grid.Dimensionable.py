...
Se implementa grid con la posibilidad de adaptar los widgets al
espacio de la ventana, cuando cambie de tamaño. """
...
class Aplicacion:
    def __init__(self):
        ...
        self.marco = ttk.Frame(
            self.raiz, borderwidth=2, relief="raised", padding=(10, 10)
        )
        ...
        self.boton1 = ttk.Button(
            self.marco, text="Aceptar", padding=(35, 5), command=self.aceptar
        )
        self.boton2 = ttk.Button(
            self.marco, text="Cancelar", padding=(35, 5), command=quit
        )
        ...
        self.boton1.grid(column=1, row=4, padx=.1, sticky=(E))
        self.boton2.grid(column=2, row=4, padx=.1, sticky=(W))
