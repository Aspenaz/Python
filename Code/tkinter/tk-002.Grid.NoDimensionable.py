...
Gestor geométrico formado por filas y columnas. Se usa en diseños en los que los controles
deben aparecer alineados en varias columnas o filas, es decir, siguiendo la forma de una tabla"""
...
Cómo usar el gestor grid con una ventana no dimensionable. También, utiliza un widget Frame 
con efecto 3D que contendrá al resto de controles. """
